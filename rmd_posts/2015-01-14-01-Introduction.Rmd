...
##Using functions
R is built off of functions and most of everything you do will uses a function.
...
#Update, may take a while if you have lots of packages
update.packages()
```
...
4. Open up a [task view](http://cran.r-project.org/web/views/) of your choosing.  Identify a package and install it. 
5. Load the package.
